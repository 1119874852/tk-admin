package com.tk.common.context;

import com.tk.auth.common.constant.CommonConstant;
import com.tk.common.util.StringHelper;
...
public class BaseContextHandler {
    ...
    public static void setName(String name){set(CommonConstant.CONTEXT_KEY_USER_NAME,name);}
